...
**`Touhou Puppet Play: Crystal`** is a work-in-progress project based off RHH/pokeemerald-expansion/1.15.1 that ports the Kanto/Johto region and storyline to a Generation III-style engine, with all Pokémon-related content replaced by characters and elements from the Touhou Project.
All outdoor Johto maps have been inserted using FireRed-style tiles as a baseline.  
All Pokémon species have been replaced with Touhou puppets.  
