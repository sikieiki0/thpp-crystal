...
#define MB_FAST_WATER 0x11 //Emerald MB_INTERIOR_DEEP_WATER : functionally the same as MB_DEEP_WATER (needs fixing)
...
#define MB_NON_ANIMATED_DOOR 0x60 //FRLG MB_CAVE_DOOR
...
#define MB_CRACKED_FLOOR_HOLE 0x66 //FRLG MB_FALL_wARP
#define MB_REGULAR_WARP 0x67 //Emerald MB_AQUA_HIDEOUT_WARP
#define MB_LAVARIDGE_GYM_1F_WARP 0x68
#define MB_ANIMATED_DOOR 0x69 //FRLG MB_WARP_DOOR 0x69
...
#define MB_CABINET 0xD7
#define MB_KITCHEN 0xD8
#define MB_DRESSER 0xD9
#define MB_SNACKS 0xDA
#define MB_FOOD 0xDB
#define MB_BLUEPRINTS 0xDC
#define MB_PAINTING 0xDD
#define MB_TELEPHONE 0xDE
#define MB_COMPUTER 0xDF
