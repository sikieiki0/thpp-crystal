...
#define MAP_GROUP_TOWNS_AND_ROUTES MAP_GROUP(CHOUJI_TOWN)
#define MAP_GROUP_DUNGEONS MAP_GROUP(RUINS_OF_ALPH)
...
{
    {SPECIES_FEEBAS, MAP_GROUP(ROUTE12), MAP_NUM(ROUTE12)},
    {NUM_SPECIES}
};
