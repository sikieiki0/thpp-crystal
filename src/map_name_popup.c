...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_MASARA_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_TOKIWA_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_NIBI_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_HANADA_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CION_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_KUCHIBA_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_TAMAMUSHI_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SEKICHIKU_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_YAMABUKI_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_GUREN_TOWN] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_ROUTE_23_KANTO] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSECS_SEVII_123] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_WAKABA_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_YOSHINO_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_KIKYOU_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_HIWADA_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_KOGANE_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ENJU_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ASAGI_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_TANBA_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CHOUJI_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_FUSUBE_CITY] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_ROUTE_32_BONEKACENTER] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SILVER_CAVE_BONEKACENTER] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_DARK_CAVE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_UNION_CAVE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SPROUT_TOWER] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SLOWPOKE_WELL] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ILEX_FOREST] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_RADIO_TOWER] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_NATIONAL_PARK] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_RUINS_OF_ALPH] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SINJOH_RUINS] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_BRASS_TOWER] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_TIN_TOWER] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SEASIDE_CAVE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SECRET_GARDEN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_LIGHTHOUSE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_WHIRL_ISLANDS] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_MT_MORTAR] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_LAKE_OF_RAGE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ICE_PATH] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SNOWTOP_MOUNTAIN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_DRAGONS_DEN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_TOHJO_FALLS] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_INDIGO_PLATEAU] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SILVER_CAVE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_MT_SILVER] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_EMBEDDED_TOWER] = MAPPOPUP_THEME_WOOD,
};
