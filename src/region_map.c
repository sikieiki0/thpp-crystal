...
{
    [MAPSEC_WAKABA_TOWN] = {MAP_GROUP(WAKABA_TOWN), MAP_NUM(WAKABA_TOWN), HEAL_LOCATION_WAKABA_TOWN_PLAYERS_HOUSE_2F},
    [MAPSEC_YOSHINO_CITY] = {MAP_GROUP(YOSHINO_CITY), MAP_NUM(YOSHINO_CITY), HEAL_LOCATION_YOSHINO_CITY},
    [MAPSEC_KIKYOU_CITY] = {MAP_GROUP(KIKYOU_CITY), MAP_NUM(KIKYOU_CITY), HEAL_LOCATION_KIKYOU_CITY},
    [MAPSEC_HIWADA_TOWN] = {MAP_GROUP(HIWADA_TOWN), MAP_NUM(HIWADA_TOWN), HEAL_LOCATION_HIWADA_TOWN},
    [MAPSEC_KOGANE_CITY] = {MAP_GROUP(KOGANE_CITY), MAP_NUM(KOGANE_CITY), HEAL_LOCATION_KOGANE_CITY},
    [MAPSEC_ENJU_CITY] = {MAP_GROUP(ENJU_CITY), MAP_NUM(ENJU_CITY), HEAL_LOCATION_ENJU_CITY},
    [MAPSEC_ASAGI_CITY] = {MAP_GROUP(ASAGI_CITY), MAP_NUM(ASAGI_CITY), HEAL_LOCATION_ASAGI_CITY},
    [MAPSEC_TANBA_CITY] = {MAP_GROUP(TANBA_CITY), MAP_NUM(TANBA_CITY), HEAL_LOCATION_TANBA_CITY},
    [MAPSEC_CHOUJI_TOWN] = {MAP_GROUP(CHOUJI_TOWN), MAP_NUM(CHOUJI_TOWN), HEAL_LOCATION_CHOUJI_TOWN},
    [MAPSEC_FUSUBE_CITY] = {MAP_GROUP(FUSUBE_CITY), MAP_NUM(FUSUBE_CITY), HEAL_LOCATION_FUSUBE_CITY},
    [MAPSEC_JITTERBUG_TOWN] = {MAP_GROUP(JITTERBUG_TOWN), MAP_NUM(JITTERBUG_TOWN), HEAL_LOCATION_JITTERBUG_TOWN},
    [MAPSEC_INDIGO_PLATEAU] = {MAP_GROUP(INDIGO_PLATEAU), MAP_NUM(INDIGO_PLATEAU), HEAL_LOCATION_INDIGO_PLATEAU},
    [MAPSEC_SILVER_CAVE] = {MAP_GROUP(SILVER_CAVE), MAP_NUM(SILVER_CAVE), HEAL_LOCATION_SILVER_CAVE},
    [MAPSEC_BATTLE_FRONTIER] = {MAP_GROUP(BATTLE_FRONTIER), MAP_NUM(BATTLE_FRONTIER), HEAL_LOCATION_BATTLE_FRONTIER},
};
    ...
    case 1:
        if (!UpdatePaletteFade())
        {
            ...
            if (sFlyMap->choseFlyLocation)
            {
                ...
                {
                case MAPSEC_WAKABA_TOWN:
                    SetWarpDestinationToHealLocation(HEAL_LOCATION_WAKABA_TOWN_PLAYERS_HOUSE_2F);
                    break;
                default:
