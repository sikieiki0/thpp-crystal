...
static const u8 sDebugText_PCBag_Fill_PocketPokeBalls[] =    _("Fill Pocket Miko Orbs");
...
static const u8 sDebugText_FlagsVars_PokedexFlags_All[] =    _("Artbook Flags All");
static const u8 sDebugText_FlagsVars_PokedexFlags_Reset[] =  _("Artbook Flags Reset");
static const u8 sDebugText_FlagsVars_SwitchDex[] =           _("Toggle {STR_VAR_1}Artbook");
static const u8 sDebugText_FlagsVars_SwitchNationalDex[] =   _("Toggle {STR_VAR_1}National Artbook");
static const u8 sDebugText_FlagsVars_SwitchPokeNav[] =       _("Toggle {STR_VAR_1}TōhōNav");
...
static const u8 sDebugText_Give_GivePokemonSimple[] =   _("Bonéka (Basic){CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Give_GivePokemonComplex[] =  _("Bonéka (Complex){CLEAR_TO 110}{RIGHT_ARROW}");
