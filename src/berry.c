...
const struct Berry gBerries[] =
{
    ...
    [ITEM_WIKI_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description2 = COMPOUND_STRING("to help Bonéka grip it."),
        .growthDuration = GROWTH_DURATION(24, 20, 30, 24, 16, 24),
        .spicy = 0,
        .dry = 10,
        .sweet = 0,
    ...
    [ITEM_TANGA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description2 = COMPOUND_STRING("Bug Bonéka with its stringy petals."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 20,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_COLBUR_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description2 = COMPOUND_STRING("Bonéka to reach far-off places."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 0,
        .dry = 0,
        .sweet = 0,
