...
{
    // Kanto
    KANTO_TO_NATIONAL(CREIMU98),
    KANTO_TO_NATIONAL(REIMU98),
    KANTO_TO_NATIONAL(CSHINGYOKU),
    KANTO_TO_NATIONAL(SHINGYOKUO),
    KANTO_TO_NATIONAL(SHINGYOKUM),
    KANTO_TO_NATIONAL(SHINGYOKUF),
    KANTO_TO_NATIONAL(CYUUGENMAGAN),
    KANTO_TO_NATIONAL(YUUGENMAGAN),
    KANTO_TO_NATIONAL(CMIMA),
    KANTO_TO_NATIONAL(MIMA),
    KANTO_TO_NATIONAL(CELIS),
    KANTO_TO_NATIONAL(ELIS),
    KANTO_TO_NATIONAL(CKIKURI),
    KANTO_TO_NATIONAL(KIKURI),
    KANTO_TO_NATIONAL(CSARIEL),
    KANTO_TO_NATIONAL(SARIEL),
    KANTO_TO_NATIONAL(SSARIEL),
    KANTO_TO_NATIONAL(CKONNGARA),
    KANTO_TO_NATIONAL(KONNGARA),
    KANTO_TO_NATIONAL(CMARISA98),
    KANTO_TO_NATIONAL(MARISA98),
    KANTO_TO_NATIONAL(GENJII),
    KANTO_TO_NATIONAL(CRIKA),
    KANTO_TO_NATIONAL(RIKA),
    KANTO_TO_NATIONAL(CMEIRA),
    KANTO_TO_NATIONAL(MEIRA),
    KANTO_TO_NATIONAL(MAGICSTONES),
    KANTO_TO_NATIONAL(CELLEN),
    KANTO_TO_NATIONAL(ELLEN),
    KANTO_TO_NATIONAL(CKOTOHIME),
    KANTO_TO_NATIONAL(KOTOHIME),
    KANTO_TO_NATIONAL(CKANA),
    KANTO_TO_NATIONAL(KANA),
    KANTO_TO_NATIONAL(CRIKAKO),
    KANTO_TO_NATIONAL(RIKAKO),
    KANTO_TO_NATIONAL(CCHIYURI),
    KANTO_TO_NATIONAL(CHIYURI),
    KANTO_TO_NATIONAL(CYUMEMI),
    KANTO_TO_NATIONAL(YUMEMI),
    KANTO_TO_NATIONAL(RUUKOTO),
    KANTO_TO_NATIONAL(MIMICHAN),
    KANTO_TO_NATIONAL(FAIRY),
    KANTO_TO_NATIONAL(CORANGE),
    KANTO_TO_NATIONAL(ORANGE),
    KANTO_TO_NATIONAL(CKURUMI),
    KANTO_TO_NATIONAL(KURUMI),
    KANTO_TO_NATIONAL(CELLY),
    KANTO_TO_NATIONAL(ELLY),
    KANTO_TO_NATIONAL(CYUUKA98),
    KANTO_TO_NATIONAL(YUUKA98),
    KANTO_TO_NATIONAL(AYUUKA98),
    KANTO_TO_NATIONAL(CMUGETSU),
    KANTO_TO_NATIONAL(MUGETSU),
    KANTO_TO_NATIONAL(CGENGETSU),
    KANTO_TO_NATIONAL(GENGETSU),
    KANTO_TO_NATIONAL(CALICE98),
    KANTO_TO_NATIONAL(ALICE98),
    KANTO_TO_NATIONAL(CSARA),
    KANTO_TO_NATIONAL(SARA),
    KANTO_TO_NATIONAL(CLUIZE),
    KANTO_TO_NATIONAL(LUIZE),
    KANTO_TO_NATIONAL(CYUKI),
    KANTO_TO_NATIONAL(YUKI),
    KANTO_TO_NATIONAL(CMAI),
    KANTO_TO_NATIONAL(MAI),
    KANTO_TO_NATIONAL(CYUMEKO),
    KANTO_TO_NATIONAL(YUMEKO),
    KANTO_TO_NATIONAL(CSHINKI),
    KANTO_TO_NATIONAL(SHINKI),
    KANTO_TO_NATIONAL(CDAIYOUSEI),
    KANTO_TO_NATIONAL(DAIYOUSEI),
    KANTO_TO_NATIONAL(CREIMU),
    KANTO_TO_NATIONAL(REIMU),
    KANTO_TO_NATIONAL(AREIMU),
    KANTO_TO_NATIONAL(DREIMU),
    KANTO_TO_NATIONAL(CMARISA),
    KANTO_TO_NATIONAL(MARISA),
    KANTO_TO_NATIONAL(AMARISA),
    KANTO_TO_NATIONAL(SMARISA),
    KANTO_TO_NATIONAL(ADMARISA),
    KANTO_TO_NATIONAL(EXMARISA),
    KANTO_TO_NATIONAL(CRUMIA),
    KANTO_TO_NATIONAL(RUMIA),
    KANTO_TO_NATIONAL(ARUMIA),
    KANTO_TO_NATIONAL(SRUMIA),
    KANTO_TO_NATIONAL(ADAIYOUSEI),
    KANTO_TO_NATIONAL(DDAIYOUSEI),
    KANTO_TO_NATIONAL(CCIRNO),
    KANTO_TO_NATIONAL(CIRNO),
    KANTO_TO_NATIONAL(SCIRNO),
    KANTO_TO_NATIONAL(TCIRNO),
    KANTO_TO_NATIONAL(ADCIRNO),
    KANTO_TO_NATIONAL(CMEILING),
    KANTO_TO_NATIONAL(MEILING),
    KANTO_TO_NATIONAL(DMEILING),
    KANTO_TO_NATIONAL(SMEILING),
    KANTO_TO_NATIONAL(ADMEILING),
    KANTO_TO_NATIONAL(CKOAKUMA),
    KANTO_TO_NATIONAL(KOAKUMA),
    KANTO_TO_NATIONAL(HKOAKUMA),
    KANTO_TO_NATIONAL(CPATCHOULI),
    KANTO_TO_NATIONAL(PATCHOULI),
    KANTO_TO_NATIONAL(APATCHOULI),
    KANTO_TO_NATIONAL(DPATCHOULI),
    KANTO_TO_NATIONAL(CSAKUYA),
    KANTO_TO_NATIONAL(SAKUYA),
    KANTO_TO_NATIONAL(TSAKUYA),
    KANTO_TO_NATIONAL(HSAKUYA),
    KANTO_TO_NATIONAL(CREMILIA),
    KANTO_TO_NATIONAL(REMILIA),
    KANTO_TO_NATIONAL(AREMILIA),
    KANTO_TO_NATIONAL(DREMILIA),
    KANTO_TO_NATIONAL(CFLANDRE),
    KANTO_TO_NATIONAL(FLANDRE),
    KANTO_TO_NATIONAL(AFLANDRE),
    KANTO_TO_NATIONAL(SFLANDRE),
    KANTO_TO_NATIONAL(CSATSUKI),
    KANTO_TO_NATIONAL(SATSUKI),
    KANTO_TO_NATIONAL(CCHEN),
    KANTO_TO_NATIONAL(CHEN),
    KANTO_TO_NATIONAL(CLETTY),
    KANTO_TO_NATIONAL(LETTY),
    KANTO_TO_NATIONAL(DLETTY),
    KANTO_TO_NATIONAL(HLETTY),
    KANTO_TO_NATIONAL(ADLETTY),
    KANTO_TO_NATIONAL(ACHEN),
    KANTO_TO_NATIONAL(TCHEN),
    KANTO_TO_NATIONAL(ADCHEN),
    KANTO_TO_NATIONAL(CALICE),
    KANTO_TO_NATIONAL(ALICE),
    KANTO_TO_NATIONAL(AALICE),
    KANTO_TO_NATIONAL(TALICE),
    KANTO_TO_NATIONAL(ADALICE),
    KANTO_TO_NATIONAL(DARKALICE),
    KANTO_TO_NATIONAL(SHANGHAI),
    KANTO_TO_NATIONAL(HOURAI),
    KANTO_TO_NATIONAL(CLILYWHITE),
    KANTO_TO_NATIONAL(LILYWHITE),
    KANTO_TO_NATIONAL(ALILYWHITE),
    KANTO_TO_NATIONAL(HLILYWHITE),
    KANTO_TO_NATIONAL(CLILYBLACK),
    KANTO_TO_NATIONAL(LILYBLACK),
    KANTO_TO_NATIONAL(ALILYBLACK),
    KANTO_TO_NATIONAL(SLILYBLACK),
    KANTO_TO_NATIONAL(CLUNASA),
    KANTO_TO_NATIONAL(LUNASA),
    KANTO_TO_NATIONAL(HLUNASA),
    KANTO_TO_NATIONAL(CMERLIN),
    KANTO_TO_NATIONAL(MERLIN),
    KANTO_TO_NATIONAL(HMERLIN),
    KANTO_TO_NATIONAL(CLYRICA),
    KANTO_TO_NATIONAL(LYRICA),
    KANTO_TO_NATIONAL(HLYRICA),
    KANTO_TO_NATIONAL(PRISMRIVER),
    KANTO_TO_NATIONAL(CYOUMU),
    KANTO_TO_NATIONAL(YOUMU),
    KANTO_TO_NATIONAL(DYOUMU),
    KANTO_TO_NATIONAL(SYOUMU),
    KANTO_TO_NATIONAL(ADYOUMU),
    KANTO_TO_NATIONAL(CYUYUKO),
    KANTO_TO_NATIONAL(YUYUKO),
    KANTO_TO_NATIONAL(AYUYUKO),
    KANTO_TO_NATIONAL(DYUYUKO),
    KANTO_TO_NATIONAL(ADYUYUKO),
    KANTO_TO_NATIONAL(CRAN),
    KANTO_TO_NATIONAL(RAN),
    KANTO_TO_NATIONAL(ARAN),
    KANTO_TO_NATIONAL(HRAN),
    KANTO_TO_NATIONAL(ADRAN),
    KANTO_TO_NATIONAL(CYUKARI),
    KANTO_TO_NATIONAL(YUKARI),
    KANTO_TO_NATIONAL(DYUKARI),
    KANTO_TO_NATIONAL(TYUKARI),
    KANTO_TO_NATIONAL(ADYUKARI),
    KANTO_TO_NATIONAL(KEDAMA),
    KANTO_TO_NATIONAL(CLAYLA),
    KANTO_TO_NATIONAL(LAYLA),
    KANTO_TO_NATIONAL(DLAYLA),
    KANTO_TO_NATIONAL(YOUKI),
    KANTO_TO_NATIONAL(AYAKASHI),
    KANTO_TO_NATIONAL(CWRIGGLE),
    KANTO_TO_NATIONAL(WRIGGLE),
    KANTO_TO_NATIONAL(DWRIGGLE),
    KANTO_TO_NATIONAL(SWRIGGLE),
    KANTO_TO_NATIONAL(CMYSTIA),
    KANTO_TO_NATIONAL(MYSTIA),
    KANTO_TO_NATIONAL(AMYSTIA),
    KANTO_TO_NATIONAL(HMYSTIA),
    KANTO_TO_NATIONAL(ADMYSTIA),
    KANTO_TO_NATIONAL(CKEINE),
    KANTO_TO_NATIONAL(KEINE),
    KANTO_TO_NATIONAL(AKEINE),
    KANTO_TO_NATIONAL(DKEINE),
    KANTO_TO_NATIONAL(HKEINE),
    KANTO_TO_NATIONAL(CTEWI),
    KANTO_TO_NATIONAL(TEWI),
    KANTO_TO_NATIONAL(ATEWI),
    KANTO_TO_NATIONAL(DTEWI),
    KANTO_TO_NATIONAL(ADTEWI),
    KANTO_TO_NATIONAL(CREISEN),
    KANTO_TO_NATIONAL(REISEN),
    KANTO_TO_NATIONAL(DREISEN),
    KANTO_TO_NATIONAL(TREISEN),
    KANTO_TO_NATIONAL(ADREISEN),
    KANTO_TO_NATIONAL(CEIRIN),
    KANTO_TO_NATIONAL(EIRIN),
    KANTO_TO_NATIONAL(AEIRIN),
    KANTO_TO_NATIONAL(HEIRIN),
    KANTO_TO_NATIONAL(ADEIRIN),
    KANTO_TO_NATIONAL(CKAGUYA),
    KANTO_TO_NATIONAL(KAGUYA),
    KANTO_TO_NATIONAL(AKAGUYA),
    KANTO_TO_NATIONAL(DKAGUYA),
    KANTO_TO_NATIONAL(CMOKOU),
    KANTO_TO_NATIONAL(MOKOU),
    KANTO_TO_NATIONAL(AMOKOU),
    KANTO_TO_NATIONAL(DMOKOU),
    KANTO_TO_NATIONAL(ADMOKOU),
    KANTO_TO_NATIONAL(CAYA),
    KANTO_TO_NATIONAL(AYA),
    KANTO_TO_NATIONAL(SAYA),
    KANTO_TO_NATIONAL(TAYA),
    KANTO_TO_NATIONAL(CMEDICINE),
    KANTO_TO_NATIONAL(MEDICINE),
    KANTO_TO_NATIONAL(AMEDICINE),
    KANTO_TO_NATIONAL(SMEDICINE),
    KANTO_TO_NATIONAL(TMEDICINE),
    KANTO_TO_NATIONAL(CYUUKA),
    KANTO_TO_NATIONAL(YUUKA),
    KANTO_TO_NATIONAL(AYUUKA),
    KANTO_TO_NATIONAL(TYUUKA),
    KANTO_TO_NATIONAL(CKOMACHI),
    KANTO_TO_NATIONAL(KOMACHI),
    KANTO_TO_NATIONAL(AKOMACHI),
    KANTO_TO_NATIONAL(SKOMACHI),
    KANTO_TO_NATIONAL(CEIKI),
    KANTO_TO_NATIONAL(EIKI),
    KANTO_TO_NATIONAL(AEIKI),
    KANTO_TO_NATIONAL(DEIKI),
    KANTO_TO_NATIONAL(CSHIZUHA),
    KANTO_TO_NATIONAL(SHIZUHA),
    KANTO_TO_NATIONAL(SSHIZUHA),
    KANTO_TO_NATIONAL(HSHIZUHA),
    KANTO_TO_NATIONAL(CMINORIKO),
    KANTO_TO_NATIONAL(MINORIKO),
    KANTO_TO_NATIONAL(AMINORIKO),
    KANTO_TO_NATIONAL(DMINORIKO),
    KANTO_TO_NATIONAL(AKISISTERS),
    KANTO_TO_NATIONAL(CHINA),
    KANTO_TO_NATIONAL(HINA),
    KANTO_TO_NATIONAL(AHINA),
    KANTO_TO_NATIONAL(DHINA),
    KANTO_TO_NATIONAL(CNITORI),
    KANTO_TO_NATIONAL(NITORI),
    KANTO_TO_NATIONAL(ANITORI),
    KANTO_TO_NATIONAL(TNITORI),
    KANTO_TO_NATIONAL(CMOMIJI),
    KANTO_TO_NATIONAL(MOMIJI),
    KANTO_TO_NATIONAL(DMOMIJI),
    KANTO_TO_NATIONAL(CSANAE),
    KANTO_TO_NATIONAL(SANAE),
    KANTO_TO_NATIONAL(ASANAE),
    KANTO_TO_NATIONAL(TSANAE),
    KANTO_TO_NATIONAL(SGSANAE),
    KANTO_TO_NATIONAL(CKANAKO),
    KANTO_TO_NATIONAL(KANAKO),
    KANTO_TO_NATIONAL(AKANAKO),
    KANTO_TO_NATIONAL(DKANAKO),
    KANTO_TO_NATIONAL(CSUWAKO),
    KANTO_TO_NATIONAL(SUWAKO),
    KANTO_TO_NATIONAL(ASUWAKO),
    KANTO_TO_NATIONAL(DSUWAKO),
    KANTO_TO_NATIONAL(CTENMA),
    KANTO_TO_NATIONAL(TENMA),
    KANTO_TO_NATIONAL(STENMA),
    KANTO_TO_NATIONAL(CKISUME),
    KANTO_TO_NATIONAL(KISUME),
    KANTO_TO_NATIONAL(TKISUME),
    KANTO_TO_NATIONAL(CYAMAME),
    KANTO_TO_NATIONAL(YAMAME),
    KANTO_TO_NATIONAL(SYAMAME),
    KANTO_TO_NATIONAL(TYAMAME),
    KANTO_TO_NATIONAL(CPARSEE),
    KANTO_TO_NATIONAL(PARSEE),
    KANTO_TO_NATIONAL(DPARSEE),
    KANTO_TO_NATIONAL(TPARSEE),
    KANTO_TO_NATIONAL(CYUUGI),
    KANTO_TO_NATIONAL(YUUGI),
    KANTO_TO_NATIONAL(AYUUGI),
    KANTO_TO_NATIONAL(DYUUGI),
    KANTO_TO_NATIONAL(CSATORI),
    KANTO_TO_NATIONAL(SATORI),
    KANTO_TO_NATIONAL(DSATORI),
    KANTO_TO_NATIONAL(TSATORI),
    KANTO_TO_NATIONAL(CRIN),
    KANTO_TO_NATIONAL(RIN),
    KANTO_TO_NATIONAL(ARIN),
    KANTO_TO_NATIONAL(SRIN),
    KANTO_TO_NATIONAL(ZOMBIEFAIRY),
    KANTO_TO_NATIONAL(CUTSUHO),
    KANTO_TO_NATIONAL(UTSUHO),
    KANTO_TO_NATIONAL(AUTSUHO),
    KANTO_TO_NATIONAL(SUTSUHO),
    KANTO_TO_NATIONAL(CKOISHI),
    KANTO_TO_NATIONAL(KOISHI),
    KANTO_TO_NATIONAL(AKOISHI),
    KANTO_TO_NATIONAL(SKOISHI),
    KANTO_TO_NATIONAL(CNAZRIN),
    KANTO_TO_NATIONAL(NAZRIN),
    KANTO_TO_NATIONAL(TNAZRIN),
    KANTO_TO_NATIONAL(HNAZRIN),
    KANTO_TO_NATIONAL(CKOGASA),
    KANTO_TO_NATIONAL(KOGASA),
    KANTO_TO_NATIONAL(SKOGASA),
    KANTO_TO_NATIONAL(TKOGASA),
    KANTO_TO_NATIONAL(CICHIRIN),
    KANTO_TO_NATIONAL(ICHIRIN),
    KANTO_TO_NATIONAL(DICHIRIN),
    KANTO_TO_NATIONAL(TICHIRIN),
    KANTO_TO_NATIONAL(CMINAMITSU),
    KANTO_TO_NATIONAL(MINAMITSU),
    KANTO_TO_NATIONAL(AMINAMITSU),
    KANTO_TO_NATIONAL(DMINAMITSU),
    KANTO_TO_NATIONAL(CSHOU),
    KANTO_TO_NATIONAL(SHOU),
    KANTO_TO_NATIONAL(ASHOU),
    KANTO_TO_NATIONAL(TSHOU),
    KANTO_TO_NATIONAL(CBYAKUREN),
    KANTO_TO_NATIONAL(BYAKUREN),
    KANTO_TO_NATIONAL(DBYAKUREN),
    KANTO_TO_NATIONAL(TBYAKUREN),
    KANTO_TO_NATIONAL(CNUE),
    KANTO_TO_NATIONAL(NUE),
    KANTO_TO_NATIONAL(ANUE),
    KANTO_TO_NATIONAL(TNUE),
    KANTO_TO_NATIONAL(CKYOUKO),
    KANTO_TO_NATIONAL(KYOUKO),
    KANTO_TO_NATIONAL(CYOSHIKA),
    KANTO_TO_NATIONAL(YOSHIKA),
    KANTO_TO_NATIONAL(CSEIGA),
    KANTO_TO_NATIONAL(SEIGA),
    KANTO_TO_NATIONAL(CTOJIKO),
    KANTO_TO_NATIONAL(TOJIKO),
    KANTO_TO_NATIONAL(CFUTO),
    KANTO_TO_NATIONAL(FUTO),
    KANTO_TO_NATIONAL(CMIKO),
    KANTO_TO_NATIONAL(MIKO),
    KANTO_TO_NATIONAL(CMAMIZOU),
    KANTO_TO_NATIONAL(MAMIZOU),
    KANTO_TO_NATIONAL(CWAKASAGIHIME),
    KANTO_TO_NATIONAL(WAKASAGIHIME),
    KANTO_TO_NATIONAL(CSEKIBANKI),
    KANTO_TO_NATIONAL(SEKIBANKI),
    KANTO_TO_NATIONAL(CKAGEROU),
    KANTO_TO_NATIONAL(KAGEROU),
    KANTO_TO_NATIONAL(CBENBEN),
    KANTO_TO_NATIONAL(BENBEN),
    KANTO_TO_NATIONAL(CYATSUHASHI),
    KANTO_TO_NATIONAL(YATSUHASHI),
    KANTO_TO_NATIONAL(CSEIJA),
    KANTO_TO_NATIONAL(SEIJA),
    KANTO_TO_NATIONAL(CSHINMYOUMARU),
    KANTO_TO_NATIONAL(SHINMYOUMARU),
    KANTO_TO_NATIONAL(CRAIKO),
    KANTO_TO_NATIONAL(RAIKO),
    KANTO_TO_NATIONAL(CSEIRAN),
    KANTO_TO_NATIONAL(SEIRAN),
    KANTO_TO_NATIONAL(CRINGO),
    KANTO_TO_NATIONAL(RINGO),
    KANTO_TO_NATIONAL(CDOREMY),
    KANTO_TO_NATIONAL(DOREMY),
    KANTO_TO_NATIONAL(CSAGUME),
    KANTO_TO_NATIONAL(SAGUME),
    KANTO_TO_NATIONAL(CCLOWNPIECE),
    KANTO_TO_NATIONAL(CLOWNPIECE),
    KANTO_TO_NATIONAL(CJUNKO),
    KANTO_TO_NATIONAL(JUNKO),
    KANTO_TO_NATIONAL(CHECATIA),
    KANTO_TO_NATIONAL(HECATIA),
    KANTO_TO_NATIONAL(CETERNITYLARVA),
    KANTO_TO_NATIONAL(ETERNITYLARVA),
    KANTO_TO_NATIONAL(CNEMUNO),
    KANTO_TO_NATIONAL(NEMUNO),
    KANTO_TO_NATIONAL(CAUNN),
    KANTO_TO_NATIONAL(AUNN),
    KANTO_TO_NATIONAL(CNARUMI),
    KANTO_TO_NATIONAL(NARUMI),
    KANTO_TO_NATIONAL(CTEIREIDA),
    KANTO_TO_NATIONAL(TEIREIDA),
    KANTO_TO_NATIONAL(CSATONO),
    KANTO_TO_NATIONAL(SATONO),
    KANTO_TO_NATIONAL(COKINA),
    KANTO_TO_NATIONAL(OKINA),
    KANTO_TO_NATIONAL(OKINAMAIDS),
    KANTO_TO_NATIONAL(CEIKA),
    KANTO_TO_NATIONAL(EIKA),
    KANTO_TO_NATIONAL(CURUMI),
    KANTO_TO_NATIONAL(URUMI),
    KANTO_TO_NATIONAL(CKUTAKA),
    KANTO_TO_NATIONAL(KUTAKA),
    KANTO_TO_NATIONAL(CYACHIE),
    KANTO_TO_NATIONAL(YACHIE),
    KANTO_TO_NATIONAL(CMAYUMI),
    KANTO_TO_NATIONAL(MAYUMI),
    KANTO_TO_NATIONAL(CKEIKI),
    KANTO_TO_NATIONAL(KEIKI),
    KANTO_TO_NATIONAL(CSAKI),
    KANTO_TO_NATIONAL(SAKI),
    KANTO_TO_NATIONAL(CMIKE),
    KANTO_TO_NATIONAL(MIKE),
    KANTO_TO_NATIONAL(CTAKANE),
    KANTO_TO_NATIONAL(TAKANE),
    KANTO_TO_NATIONAL(CSANNYO),
    KANTO_TO_NATIONAL(SANNYO),
    KANTO_TO_NATIONAL(CMISUMARU),
    KANTO_TO_NATIONAL(MISUMARU),
    KANTO_TO_NATIONAL(CTSUKASA),
    KANTO_TO_NATIONAL(TSUKASA),
    KANTO_TO_NATIONAL(CMEGUMU),
    KANTO_TO_NATIONAL(MEGUMU),
    KANTO_TO_NATIONAL(CCHIMATA),
    KANTO_TO_NATIONAL(CHIMATA),
    KANTO_TO_NATIONAL(CMOMOYO),
    KANTO_TO_NATIONAL(MOMOYO),
    KANTO_TO_NATIONAL(CBITEN),
    KANTO_TO_NATIONAL(BITEN),
    KANTO_TO_NATIONAL(CENOKO),
    KANTO_TO_NATIONAL(ENOKO),
    KANTO_TO_NATIONAL(CCHIYARI),
    KANTO_TO_NATIONAL(CHIYARI),
    KANTO_TO_NATIONAL(CHISAMI),
    KANTO_TO_NATIONAL(HISAMI),
    KANTO_TO_NATIONAL(CZANMU),
    KANTO_TO_NATIONAL(ZANMU),
    KANTO_TO_NATIONAL(CUBAME),
    KANTO_TO_NATIONAL(UBAME),
    KANTO_TO_NATIONAL(CCHIMI),
    KANTO_TO_NATIONAL(CHIMI),
    KANTO_TO_NATIONAL(CNAREKO),
    KANTO_TO_NATIONAL(NAREKO),
    KANTO_TO_NATIONAL(CASAMA),
    KANTO_TO_NATIONAL(ASAMA),
    KANTO_TO_NATIONAL(CARIYA),
    KANTO_TO_NATIONAL(ARIYA),
    KANTO_TO_NATIONAL(CNINA),
    KANTO_TO_NATIONAL(NINA),
    KANTO_TO_NATIONAL(TORI),
    KANTO_TO_NATIONAL(ISAMI),
    KANTO_TO_NATIONAL(CVIVIT),
    KANTO_TO_NATIONAL(VIVIT),
    KANTO_TO_NATIONAL(ANVIVIT),
    KANTO_TO_NATIONAL(CTOKIKO),
    KANTO_TO_NATIONAL(TOKIKO),
    KANTO_TO_NATIONAL(ATOKIKO),
    KANTO_TO_NATIONAL(AKYUU),
    KANTO_TO_NATIONAL(CRINNOSUKE),
    KANTO_TO_NATIONAL(RINNOSUKE),
    KANTO_TO_NATIONAL(GYOKUTO),
    KANTO_TO_NATIONAL(CTOYOHIME),
    KANTO_TO_NATIONAL(TOYOHIME),
    KANTO_TO_NATIONAL(TTOYOHIME),
    KANTO_TO_NATIONAL(CYORIHIME),
    KANTO_TO_NATIONAL(YORIHIME),
    KANTO_TO_NATIONAL(SYORIHIME),
    KANTO_TO_NATIONAL(CKASEN),
    KANTO_TO_NATIONAL(KASEN),
    KANTO_TO_NATIONAL(CSENDAI),
    KANTO_TO_NATIONAL(SENDAI),
    KANTO_TO_NATIONAL(TSENDAI),
    KANTO_TO_NATIONAL(CKOSUZU),
    KANTO_TO_NATIONAL(KOSUZU),
    KANTO_TO_NATIONAL(CMIYOI),
    KANTO_TO_NATIONAL(MIYOI),
    KANTO_TO_NATIONAL(CLUNACHILD),
    KANTO_TO_NATIONAL(LUNACHILD),
    KANTO_TO_NATIONAL(ALUNACHILD),
    KANTO_TO_NATIONAL(TLUNACHILD),
    KANTO_TO_NATIONAL(CSTARSAPPHIRE),
    KANTO_TO_NATIONAL(STARSAPPHIRE),
    KANTO_TO_NATIONAL(ASTARSAPPHIRE),
    KANTO_TO_NATIONAL(HSTARSAPPHIRE),
    KANTO_TO_NATIONAL(CSUNNYMILK),
    KANTO_TO_NATIONAL(SUNNYMILK),
    KANTO_TO_NATIONAL(ASUNNYMILK),
    KANTO_TO_NATIONAL(DSUNNYMILK),
    KANTO_TO_NATIONAL(CSUIKA),
    KANTO_TO_NATIONAL(SUIKA),
    KANTO_TO_NATIONAL(ASUIKA),
    KANTO_TO_NATIONAL(TSUIKA),
    KANTO_TO_NATIONAL(MPSUIKA),
    KANTO_TO_NATIONAL(CIKU),
    KANTO_TO_NATIONAL(IKU),
    KANTO_TO_NATIONAL(DIKU),
    KANTO_TO_NATIONAL(TIKU),
    KANTO_TO_NATIONAL(CTENSHI),
    KANTO_TO_NATIONAL(TENSHI),
    KANTO_TO_NATIONAL(ATENSHI),
    KANTO_TO_NATIONAL(DTENSHI),
    KANTO_TO_NATIONAL(GOLIATH),
    KANTO_TO_NATIONAL(NAMAZU),
    KANTO_TO_NATIONAL(TENSOKU),
    KANTO_TO_NATIONAL(GTENSOKU),
    KANTO_TO_NATIONAL(CHATATE),
    KANTO_TO_NATIONAL(HATATE),
    KANTO_TO_NATIONAL(DHATATE),
    KANTO_TO_NATIONAL(THATATE),
    KANTO_TO_NATIONAL(CKOKORO),
    KANTO_TO_NATIONAL(KOKORO),
    KANTO_TO_NATIONAL(AKOKORO),
    KANTO_TO_NATIONAL(CSUMIREKO),
    KANTO_TO_NATIONAL(SUMIREKO),
    KANTO_TO_NATIONAL(CJOON),
    KANTO_TO_NATIONAL(JOON),
    KANTO_TO_NATIONAL(AJOON),
    KANTO_TO_NATIONAL(CSHION),
    KANTO_TO_NATIONAL(SHION),
    KANTO_TO_NATIONAL(SSHION),
    KANTO_TO_NATIONAL(YORIGAMISISTERS),
    KANTO_TO_NATIONAL(CYUUMA),
    KANTO_TO_NATIONAL(YUUMA),
};
