[SPECIES_CUBAME] =
    ...
    [SPECIES_CNAREKO] =
    {
        ...
        .frontPicSize = MON_COORDS_SIZE(32, 40),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_CNareko,
        .frontAnimId = ANIM_GROW_VIBRATE,
        .frontAnimDelay = 15,
        .enemyMonElevation = 0,
