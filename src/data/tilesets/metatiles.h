...
const u16 gMetatiles_VioletCity[] = INCBIN_U16("data/tilesets/secondary/violet_city_frlg/metatiles.bin");
const u16 gMetatileAttributes_VioletCity[] = INCBIN_U16("data/tilesets/secondary/violet_city_frlg/metatile_attributes.bin");
