...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_FINAL_VERDICT] =
    {
        .name = COMPOUND_STRING("Final Verdict"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SWEET_KISS] =
    {
        ...
        .effect = EFFECT_CONFUSE,
        .power = 0,
        .type = B_UPDATED_MOVE_TYPES >= GEN_6 ? TYPE_ILLUSION : TYPE_SPIRIT,
        .accuracy = 75,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_VERDANT_POWER] =
    {
        .name = COMPOUND_STRING("Verdant Power"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TERRA_SHIFT] =
    {
        .name = COMPOUND_STRING("Terra Shift"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPIRITS_EYE] =
    {
        .name = COMPOUND_STRING("Spirits Eye"),
        .description = COMPOUND_STRING(
            "Negates the foe's efforts\n"
            "to heighten evasiveness."),
        .effect = EFFECT_FORESIGHT,
