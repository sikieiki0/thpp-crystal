...
//Puppets
PLACEHOLDER_ANIM_SINGLE_FRAME(CReimu98);
PLACEHOLDER_ANIM_SINGLE_FRAME(Reimu98);
PLACEHOLDER_ANIM_SINGLE_FRAME(CMarisa98);
PLACEHOLDER_ANIM_SINGLE_FRAME(Marisa98);
PLACEHOLDER_ANIM_SINGLE_FRAME(CAlice98);
PLACEHOLDER_ANIM_SINGLE_FRAME(Alice98);
PLACEHOLDER_ANIM_SINGLE_FRAME(CNazrin);
PLACEHOLDER_ANIM_SINGLE_FRAME(Nazrin);
PLACEHOLDER_ANIM_SINGLE_FRAME(CTokiko);
PLACEHOLDER_ANIM_SINGLE_FRAME(Tokiko);
PLACEHOLDER_ANIM_SINGLE_FRAME(CDaiyousei);
PLACEHOLDER_ANIM_SINGLE_FRAME(Daiyousei);
PLACEHOLDER_ANIM_SINGLE_FRAME(CChen);
PLACEHOLDER_ANIM_SINGLE_FRAME(Chen);
PLACEHOLDER_ANIM_SINGLE_FRAME(CSeiran);
PLACEHOLDER_ANIM_SINGLE_FRAME(Seiran);
