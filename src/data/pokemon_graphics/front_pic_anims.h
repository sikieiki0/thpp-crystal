...
//Puppets
PLACEHOLDER_ANIM_SINGLE_FRAME(CHakurei);
PLACEHOLDER_ANIM_SINGLE_FRAME(Hakurei);
PLACEHOLDER_ANIM_SINGLE_FRAME(CKirisame);
PLACEHOLDER_ANIM_SINGLE_FRAME(Kirisame);
PLACEHOLDER_ANIM_SINGLE_FRAME(CArisu);
PLACEHOLDER_ANIM_SINGLE_FRAME(Arisu);
...
SINGLE_ANIMATION(CArisu);
SINGLE_ANIMATION(Arisu);
