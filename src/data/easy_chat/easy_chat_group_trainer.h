...
const u8 gEasyChatWord_Trainer[] = _("Puppeteer");
const u8 gEasyChatWord_Version[] = _("Version");
const u8 gEasyChatWord_Pokenav[] = _("TohoNav");
const u8 gEasyChatWord_Pokemon[] = _("Bonéka");
const u8 gEasyChatWord_Get[] = _("GET");
const u8 gEasyChatWord_Pokedex[] = _("Artbook");
