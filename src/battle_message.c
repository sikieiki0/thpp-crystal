...
static const u8 sText_UseNextPkmn[] = _("Use next Bonéka?");
...
static const u8 sText_FaintInThree[] = _("All Bonéka that heard the song will faint in three turns!");
...
static const u8 sText_EnemyAboutToSwitchPkmn[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME} is about to send out {B_BUFF2}.\pWill you switch your Bonéka?");
...
static const u8 sText_ItDodgedBall[] = _("It dodged your thrown Bonéka Orb! This Bonéka can't be caught!");
static const u8 sText_YouMissedPkmn[] = _("You missed the Bonéka!");
static const u8 sText_PkmnBrokeFree[] = _("Oh no! The Bonéka broke free!");
...
static const u8 sText_Lanettes[] = _("Lanettes's"); //no decapitalize until it is everywhere
static const u8 sText_PkmnDataAddedToDex[] = _("{B_DEF_NAME}'s data has been added to the Artbook!\p");
...
static const u8 sText_HeldItemsLoseEffects[] =_("It created a bizarre area in which Bonéka's held items lose their effects!");
static const u8 sText_BizarreArenaCreated[] =_("A bizarre area was created in which Bonéka's held items lose their effects!");
...
static const u8 sText_PowderExplodes[] = _("When the flame touched the powder on the Bonéka, it exploded!");
...
static const u8 sText_AuraBreakActivates[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} reversed all other Bonéka's auras!");
...
static const u8 sText_PkmnsWillPerishIn3Turns[] = _("Both Bonéka will perish in three turns!");  //don't think this message is displayed anymore
...
static const u8 sText_MysteriousAirCurrent[] = _("Mysterious strong winds are protecting Flying-type Bonéka!");
...
static const u8 sText_BothCanNoLongerEscape[] = _("Neither Bonéka can run away!");
...
static const u8 sText_RefJudgeMind[] = _("REFEREE: Judging category 1, Mind! The Bonéka showing the most guts!\p");
static const u8 sText_RefJudgeSkill[] = _("REFEREE: Judging category 2, Skill! The Bonéka using moves the best!\p");
static const u8 sText_RefJudgeBody[] = _("REFEREE: Judging category 3, Body! The Bonéka with the most vitality!\p");
