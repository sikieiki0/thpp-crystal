...
static const u8 sText_FaintInThree[] = _("All affected Bonéka will\nfaint in three turns!");
...
static const u8 sText_PkmnsWillPerishIn3Turns[] = _("Both Bonéka will perish\nin three turns!");
