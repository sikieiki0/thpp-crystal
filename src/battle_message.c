...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_NOTVERYEFFECTIVE]                     = COMPOUND_STRING("It couldn't penetrate the barrier …"),
    [STRINGID_SUPEREFFECTIVE]                       = COMPOUND_STRING("The skill passed through the barrier!"),
    [STRINGID_GOTAWAYSAFELY]                        = sText_GotAwaySafely,
    [STRINGID_WILDPKMNFLED]                         = COMPOUND_STRING("{PLAY_SE SE_FLEE}The wild {B_BUFF1} fled!"),
    [STRINGID_NORUNNINGFROMTRAINERS]                = COMPOUND_STRING("No! There's no running from a Puppeteer battle!\p"),
    ...
    [STRINGID_TRAINERBLOCKEDBALL]                   = COMPOUND_STRING("The Puppeteer blocked your Miko Orb!"),
    [STRINGID_DONTBEATHIEF]                         = COMPOUND_STRING("Don't be a thief!"),
    [STRINGID_ITDODGEDBALL]                         = COMPOUND_STRING("It dodged your thrown Miko Orb! This Bonéka can't be caught!"),
    ...
    [STRINGID_ATTACKERBECAMEFULLYCHARGED]           = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} became fully charged due to its bond with its Puppeteer!\p"),
...
void BufferStringBattle(u16 stringID, u32 battler)
{
    ...
    case STRINGID_SWITCHINMON: // switch-in msg
        ...
        break;
    case STRINGID_USEDMOVE: // Bonéka used a move msg
...
u32 BattleStringExpandPlaceholders(const u8 *src, u8 *dst, u32 dstSize)
{
    ...
    u32 toCpyWidth = 0;
    u32 dstWidth = 0;
    // This buffer may hold either the name of a trainer, Bonéka, or item.
